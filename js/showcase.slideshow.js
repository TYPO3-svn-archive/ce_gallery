...
function doSlideShow(position) {
	//alert('currentIter: '+currentIter+ 'lastIter: '+lastIter);
  if (slideShowInit == 1)
	{
		//currentIter++;
		//setTimeout(prevSlideShow,10);
		...
		if (position == 1)
		{
			if (currentIter != 0) {
				...
				$('slideElement' + parseInt(lastIter)).currentOpacity.custom(0, 0);
			}
		} else {
